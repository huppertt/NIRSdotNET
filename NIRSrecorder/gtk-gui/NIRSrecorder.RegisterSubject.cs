...
namespace NIRSrecorder
{
	public partial class RegisterSubject
	{
		...
		private global::Gtk.CheckButton checkbutton_hyperscan;
		...
		protected virtual void Build()
		{
			...
			w7.Fill = false;
			// Container child vbox8.Gtk.Box+BoxChild
			this.checkbutton_hyperscan = new global::Gtk.CheckButton();
			this.checkbutton_hyperscan.CanFocus = true;
			this.checkbutton_hyperscan.Name = "checkbutton_hyperscan";
			this.checkbutton_hyperscan.Label = global::Mono.Unix.Catalog.GetString("Hyper-scanning");
			this.checkbutton_hyperscan.DrawIndicator = true;
			this.checkbutton_hyperscan.UseUnderline = true;
			this.vbox8.Add(this.checkbutton_hyperscan);
			global::Gtk.Box.BoxChild w8 = ((global::Gtk.Box.BoxChild)(this.vbox8[this.checkbutton_hyperscan]));
			w8.Position = 4;
			w8.Expand = false;
			w8.Fill = false;
			// Container child vbox8.Gtk.Box+BoxChild
			...
			w40.Pixbuf = global::Stetic.IconLoader.LoadIcon(this, "gtk-cancel", global::Gtk.IconSize.Button);
			this.button63.Image = w40;
			this.hbox2.Add(this.button63);
			global::Gtk.Box.BoxChild w41 = ((global::Gtk.Box.BoxChild)(this.hbox2[this.button63]));
			w41.Position = 1;
			w41.Expand = false;
			w41.Fill = false;
			// Container child hbox2.Gtk.Box+BoxChild
			...
			this.button65.Image = w42;
			this.hbox2.Add(this.button65);
			global::Gtk.Box.BoxChild w43 = ((global::Gtk.Box.BoxChild)(this.hbox2[this.button65]));
			w43.Position = 2;
			w43.Expand = false;
			w43.Fill = false;
